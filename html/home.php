            ...
            <section id="g-nav" class="section">
                <nav>
                    <div class="g-nav pc-mode">
                        ...
                        <div class="menu"><a href="<?php echo home_url(); ?>">Home</a></div>
                        <div class="menu"><a href="#portfolio" alt="">Portfolio</a></div>
                        <div class="menu"><a href="#about" alt="">About</a></div>
                        <div class="menu"><a href="#send" alt="">Contact</a></div>
                    </div>
                    <div class="g-nav-m m-mode">
                        <div class="cp_offcm01">
                            ...
                            <div class="cp_menu">
                                <ul>
                                    <li class="menu-m"><a href="<?php echo home_url(); ?>">Home</a></li>
                                    <li class="menu-m"><a href="#portfolio" alt="">Portfolio</a></li>
                                    <li class="menu-m"><a href="#about" alt="">About</a></li>
                                    <li class="menu-m"><a href="#send" alt="">Contact</a></li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="container">
                    ...
                    <section id="portfolio">
                        ...
                        <article class="fadein-bottom">
                            <!-- <center> -->
                            <ul class="s-list">
                                <li><a href="portfolio.html#tsubomi"><img src="images/tsubomi_st.jpg" alt=""></a></li>
                                <li><a href="portfolio.html#nlab"><img src="images/nlab_st.jpg" alt=""></a></li>
                                <li><a href="portfolio.html#sql"><img src="images/sql_st.jpg" alt=""></a></li>
                            </ul>
                        </article>
                    </section>
                    <section id="about">
